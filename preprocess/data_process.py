...
from preprocess.utils import calculate_zero_percentage, ensure_dir_exists
import argparse
...
sc_path = 'datasets/data/' + args.document + '/' + args.sc_data
st_path = 'datasets/data/' + args.document + '/' + args.st_data
...
print(f"Dataset name is: {args.document}")
...
sc_data_save = 'datasets/data/' + args.document + '/sc/'
st_data_save = 'datasets/data/' + args.document + '/st/'
gene_name_save = 'datasets/data/' + args.document + '/gene/'
